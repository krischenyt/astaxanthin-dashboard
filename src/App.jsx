...
const ChartTooltip = ({ active, payload, label }) => {
  ...
  return (
    <div style={{ background: "#1e293b", border: "1px solid #334155", borderRadius: 8, padding: "10px 14px", fontSize: 12, minWidth: 140 }}>
      {fullDate && <div style={{ color: "#f8fafc", marginBottom: 8, fontWeight: 700, fontSize: 13, borderBottom: "1px solid #334155", paddingBottom: 6 }}>{fullDate}</div>}
