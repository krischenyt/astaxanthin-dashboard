            ...
            {SKUs.map(({ key, label, color }) => {
              ...
              return (
                <div key={key} style={s.skuCard(color)}>
                  ...
                  <div style={{ fontSize: 10, color: "#475569", marginTop: 2 }}>{dateRange}</div>
                  <div style={{ fontSize: 12, color: "#94a3b8", marginTop: 4 }}>Daily avg <b style={{ color }}>{baselines[key].daily}</b></div>
                </div>
              );
            })}
          </div>
